            ...
            if (drawingControl) {
                ...
                this.drawingManager = new google.maps.drawing.DrawingManager({
                    ...
                    drawingControlOptions: {
                        ...
                        drawingModes: [
                            ...(drawingModes.marker ? [google.maps.drawing.OverlayType.MARKER] : []),
                            ...(drawingModes.circle ? [google.maps.drawing.OverlayType.CIRCLE] : []),
                            ...(drawingModes.polygon ? [google.maps.drawing.OverlayType.POLYGON] : []),
                            ...(drawingModes.polyline ? [google.maps.drawing.OverlayType.POLYLINE] : []),
                            ...(drawingModes.rectangle ? [google.maps.drawing.OverlayType.RECTANGLE] : []),
                        ],
                    },
                    markerOptions: {
                        draggable: true
